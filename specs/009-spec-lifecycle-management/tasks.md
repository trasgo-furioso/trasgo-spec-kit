...
- [ ] T014 [P] [US3] Write failing test: status-change.sh sets status to a valid phase in tests/unit/test_status_change.py
- [ ] T015 [P] [US3] Write failing test: status-change.sh rejects invalid phase names in tests/unit/test_status_change.py
- [ ] T016 [P] [US3] Write failing test: status-change.sh selects spec.md over prd.md when both exist in tests/unit/test_status_change.py
- [ ] T017 [P] [US3] Write failing test: status-change.sh selects prd.md when no spec.md exists in tests/unit/test_status_change.py
- [ ] T018 [P] [US3] Write failing test: status-change.sh sets Blocked status in tests/unit/test_status_change.py

### Implementation for User Story 3

- [ ] T019 [US3] Create status-change.sh script with `set` action at bundle/extensions/trasgospec/scripts/bash/status-change.sh
- [ ] T020 [US3] Add `blocked` action to status-change.sh
- [ ] T021 [US3] Add `validate` action to status-change.sh
- [ ] T022 [US3] Add input validation against valid lifecycle phases in status-change.sh
- [ ] T023 [US3] Create command file speckit.trasgospec.roadmap.status.change.md at bundle/extensions/trasgospec/commands/speckit.trasgospec.roadmap.status.change.md
- [ ] T024 [US3] Create skill file SKILL.md at .claude/skills/speckit-trasgospec-roadmap-status-change/SKILL.md
- [ ] T025 [US3] Register command and alias in bundle/extensions/trasgospec/extension.yml
- [ ] T026 [US3] Install script copy to .specify/extensions/trasgospec/scripts/bash/status-change.sh
- [ ] T027 [US3] Run all status-change tests: `.venv/bin/pytest tests/unit/test_status_change.py -v`
