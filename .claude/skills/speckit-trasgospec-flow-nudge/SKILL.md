---
name: speckit-trasgospec-flow-nudge
description: Suggest PR lifecycle actions at workflow milestones.
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: trasgospec:commands/speckit.trasgospec.flow-nudge.md
---
...
1. Run `.specify/extensions/trasgospec/scripts/bash/flow-nudge.sh` from the repo root and parse the JSON output.
